...
/*----------------------------toggleClassForPARTICIPANTS------------*/
jQuery(document).ready(function($){

$(".field--name-field-decreto-meet-partic .field--label").click(function(){
  $(".field--name-field-decreto-meet-partic .col-xs-7").toggle("slideUp");
 });
});
/*----------------------------toggleClassForDESRIPTION------------*/
jQuery(document).ready(function($){

$(".field--type-text-with-summary .field--label").click(function(){
  $(".field--type-text-with-summary .col-xs-7").toggle("slideUp");
 });
});
