...
class pdf2htmlexSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['decreto_pdf2htmlex_trans_limit'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('Limit for one cron job'),
      '#default_value' => $config->get('decreto_pdf2htmlex_trans_limit'),
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set('decreto_pdf2htmlex_path', $form_state->getValue('decreto_pdf2htmlex_path'))
      ...
      ->set('decreto_pdf2htmlex_trans_limit', $form_state->getValue('decreto_pdf2htmlex_trans_limit'))
      ->save();
